...
class WorkshopListingPage(Page):
	...
	def get_context(self, request):
		...
		context['posts'] = WorkshopDetailPage.objects.all()	#live().public().order_by('pub_time')
		return context
...
class WorkshopDetailPage(Page):
	...
	date = models.CharField('workshop date (28/9/1395)',max_length=50)
