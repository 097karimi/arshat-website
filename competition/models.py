...
class CompetitionListingPage(Page):
	template = "competition/competition_listing_page.html"
	max_count = 1
	...
	def get_context(self, request):
		...
		context['posts'] = CompetitionDetailPage.objects.all()	#live().public().order_by('pub_time')
		return context


class CompetitionDetailPage(Page):
	template = "competition/competition_detail_page.html"
	...
	date = models.CharField('competition date (28/9/1395)',max_length=50)
	...
	author = models.ForeignKey(
		...
		related_name='details_competition', 
